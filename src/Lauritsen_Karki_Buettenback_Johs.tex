...
\begin{center}
  \includegraphics[width=0.65\textwidth]{runtime_vs_k.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.65\textwidth]{runtime_vs_dims.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.65\textwidth]{runtime_vs_size.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.65\textwidth]{goodness_of_clustering.png}
\end{center}
